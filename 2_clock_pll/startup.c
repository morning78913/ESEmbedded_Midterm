...
void set_sysclk_pll(void)
{
	...
	WRITE_BITS(RCC_BASE + RCC_PLLCFGR_OFFSET, PLLM_5_BIT, PLLM_0_BIT, 0b1000);
	...
	//while((RCC_BASE + RCC_CFGR_OFFSET, SWS_1_BIT) != 1) && (READ_BIT(RCC_BASE + RCC_CFGR_OFFSET, SWS+0_0_BIT) != 0)); My Answer is wrong
}
